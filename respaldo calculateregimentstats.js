...
// 3. OBTENCIÓN DE DATOS DESDE LA UNIDAD: Ahora sacamos la info del propio objeto 'unit'.    
    ...
    unit.regiments.forEach((reg, index) => {
        ...
        unit.base_regiment_stats[regId] = {
            attack: regAttack,
            defense: regDefense,
            // Guardamos más stats base por si los necesitamos en el futuro
            maxHealth: regHealth, 
            movement: baseRegData.movement
        };
    ...
    console.log(`[calculateRegimentStats] Unidad ${unit.name} procesada. Stats "de fábrica": Atk=${finalStats.attack}, Def=${finalStats.defense}.`);
}